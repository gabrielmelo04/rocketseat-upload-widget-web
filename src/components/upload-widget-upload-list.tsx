...
export function UploadWidgetUploadList() {
  const uploads = useUploads(store => store.uploads) // com o store -> Busquei minha lista de uplodas -> faz com que se eu tiver alguma alteração no meu estado que não seja a lista de uploadas ele não vai sofrer uma renderização
